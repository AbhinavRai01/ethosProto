...
const HomePage = () => {
  return (
    ...
    <main className="flex-grow flex items-center justify-center p-6 sm:p-8 md:p-12 bg-gray-900 text-white min-h-[91vh]">
      <div className="w-full max-w-4xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl">
          ...
          <div className="group relative flex flex-col items-center justify-center p-8 bg-black/20 rounded-lg border border-gray-700/50 hover:border-purple-500/50 transition-all duration-300 transform hover:-translate-y-1">
            ...
            {/* Link component styled as a button, navigating to the /user route */}
            <Link 
              to="/user" 
          ...
          <div className="group relative flex flex-col items-center justify-center p-8 bg-black/20 rounded-lg border border-gray-700/50 hover:border-purple-500/50 transition-all duration-300 transform hover:-translate-y-1">
            ...
            {/* Link component styled as a button, navigating to the /upload route */}
            <Link 
              to="/upload" 
